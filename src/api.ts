...
export async function updateLog(id: number, durationMinutes: number, charactersRead: number, date: string): Promise<void> {
  return await invoke('update_log', { id, durationMinutes, charactersRead, date });
}
